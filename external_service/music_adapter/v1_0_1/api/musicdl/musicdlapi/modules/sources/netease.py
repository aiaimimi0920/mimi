...
class Netease(Base):
    ...
    def search(self, keyword, disable_print=True):
        ...
        response = self.session.post(self.search_url, headers=self.headers, data=self.cracker.get(params))
    ...
    def __initialize(self):
        ...
        self.search_url = 'http://music.163.com/weapi/search/suggest/web?csrf_token='
