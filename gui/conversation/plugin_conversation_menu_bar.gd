extends Panel
class_name PluginConversationMenubar
...
func make_tab(cur_conversation: ConversationAPI) -> void:
	...
	tab.title = cur_conversation.conversation_name
...
func update_tab_title(cur_conversation: ConversationAPI) -> void:
	if _tabs_map.has(cur_conversation.conversation_id):
		_tabs_map[cur_conversation.conversation_id].title = cur_conversation.conversation_name
