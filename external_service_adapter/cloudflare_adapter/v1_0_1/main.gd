...
func _on_init()->void:
	super._on_init()
	set_plugin_info(plugin_name,"cloudflare_adapter","mimi",plugin_version,"It is possible to call the functions of cloudflare",
...
func get_fs_list_need_args():
	return {"path":"","region":"","bucket":"","access_key":"","secret_key":"","service":"","account_id":""}
...
func fs_list(adapter_need_data):
	...
	var account_id = adapter_need_data["account_id"]
	return await service_r2.fs_list(path, region, bucket, access_key, secret_key, service,account_id)
...
func get_fs_upload_form_need_args():
	return {"path":"","base_dir_path":"","region":"","bucket":"","access_key":"","secret_key":"","service":"","account_id":""}
...
func fs_upload_form(adapter_need_data):
	...
	var service = adapter_need_data["service"]
	var account_id = adapter_need_data["account_id"]
	return await service_r2.fs_upload_form(path, base_dir_path, region, bucket, access_key, secret_key, service, account_id)
...
func get_fs_download_need_args():
	return {"path":"","save_dir":"","region":"","bucket":"","access_key":"","secret_key":"","service":"","account_id":""}
...
func fs_download(adapter_need_data):
	...
	var service = adapter_need_data["service"]
	var account_id = adapter_need_data["account_id"]
	return await service_r2.fs_download(path, save_dir, region, bucket, access_key, secret_key, service,
			account_id)
