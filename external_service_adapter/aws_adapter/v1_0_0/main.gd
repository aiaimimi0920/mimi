...
func _on_init()->void:
	super._on_init()
	set_plugin_info(plugin_name,"aws_adapter","mimi",plugin_version,"It is possible to call the functions of AWS","service",{})
...
func fs_list(sub_path, region="", bucket="", access_key="", secret_key="", service="",):
	return await service_s3.fs_list(sub_path, region, bucket, access_key, secret_key, service)
...
func fs_upload_form(sub_path, base_dir_path="", region="", bucket="", access_key="", secret_key="", service=""):
	return await service_s3.fs_upload_form(sub_path, base_dir_path, region, bucket, access_key, secret_key, service)
...
func fs_download(sub_path, cur_save_dir="", region="", bucket="", access_key="", secret_key="", service=""):
	return await service_s3.fs_download(sub_path, cur_save_dir, region, bucket, access_key, secret_key, service)
